...
| Report Run           | Excel Report Run         | Represents Report Runs executed in the Cloud edition on [app.owox.com](https://app.owox.com). Data was pulled from a Data Mart into a Microsoft Excel workbook by the OWOX add-in. |
