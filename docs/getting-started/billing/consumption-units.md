...
A **Report Run** means pushing or pulling data (stored in **Storage**) to a **Destination**. Reading data through the HTTP Data API, the [MCP Server](../setup-guide/mcp.md), or a [Data Preview](../setup-guide/data-preview.md) also counts. Read more about [core concepts](../core-concepts.md).
...
| Report Run           | Excel Report Run         | Represents Report Runs executed in the Cloud edition on [app.owox.com](https://app.owox.com). Data was pulled from a Data Mart into a Microsoft Excel workbook by the OWOX add-in. See [Microsoft Excel](../../destinations/supported-destinations/microsoft-excel.md).                                           |
...
| Report Run           | Data Preview Run         | Represents Report Runs executed in the Cloud edition on [app.owox.com](https://app.owox.com). A sample of rows was read from a Data Mart with [Data Preview](../setup-guide/data-preview.md) on the **Data Setup** tab.                                                                                            |
