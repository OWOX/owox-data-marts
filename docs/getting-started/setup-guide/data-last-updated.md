...
Data Last Updated is currently measured for **Google BigQuery**, **AWS Redshift**, **AWS Athena**, and **Databricks** Data Marts. Data Marts on other storages show **Unknown** until their support lands.
