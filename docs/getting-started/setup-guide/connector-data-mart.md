...
Select the platform you want to connect to (e.g., [Facebook Ads](../../../packages/connectors/src/Sources/FacebookMarketing/README.md), [TikTok Ads](../../../packages/connectors/src/Sources/TikTokAds/README.md)) from the list of available connectors and click **Next**. Connectors built in your project are listed under **Custom Connectors**; to build one, see [Connector Builder](../../connectors/connector-builder.md).
