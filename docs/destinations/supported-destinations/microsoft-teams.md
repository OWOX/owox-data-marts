...
Configure **Microsoft Teams** as a Destination in OWOX Data Marts to allow business users to receive messages with Insights based on the results of each Data Mart run.  
