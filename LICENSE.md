...
Portions of the Software are provided under the following terms and licenses:
...
- Enterprise features are licensed under the Enterprise License (licenses/ee.md) and are located
  in the `apps/backend/src/ee` directory,
...
- All third-party components incorporated into the Software are licensed under
