...
@Entity({ name: 'data_destination_search_index' })
@Index('idx_data_destination_search_index_project', ['projectId'])
@Index('idx_data_destination_search_index_project_entity', ['projectId', 'entityId'])
export class DataDestinationSearchIndex {
