...
export class BigQueryReportReader implements DataStorageReportReader {
  ...
  private reportResultHeaders: ReportDataHeader[];
  ...
  public async prepareReportData(report: Report): Promise<ReportDataDescription> {
    ...
    this.reportResultHeaders = this.headersGenerator.generateHeaders(schema);

    return new ReportDataDescription(this.reportResultHeaders);
  }
