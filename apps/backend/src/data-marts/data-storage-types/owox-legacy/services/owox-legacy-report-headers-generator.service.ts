...
/**
 * OWOX Legacy Report Headers Generator.
 * Same logic as BigQuery report headers generator.
 */
@Injectable()
export class OwoxLegacyReportHeadersGenerator implements ReportHeadersGenerator {
