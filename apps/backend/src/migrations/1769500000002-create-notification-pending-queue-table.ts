    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'notificationType', type: 'varchar', length: '191', isNullable: false },
          { name: 'projectId', type: 'varchar', length: '191', isNullable: false },
          { name: 'dataMartId', type: 'varchar', length: '191', isNullable: false, default: "''" },
          { name: 'runId', type: 'varchar', length: '191', isNullable: false, default: "''" },
