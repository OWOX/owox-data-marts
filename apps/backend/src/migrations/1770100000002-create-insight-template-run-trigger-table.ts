...
export class CreateInsightTemplateRunTriggerTable1770100000002 implements MigrationInterface {
  name = 'CreateInsightTemplateRunTriggerTable1770100000002';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.createTable(
      new Table({
        name: 'insight_template_run_triggers',
        columns: [
          ...
          { name: 'insightTemplateId', type: 'varchar', isNullable: false },
        ...
        indices: [
          {
            name: 'idx_insight_template_run_trigger_status',
            columnNames: ['status', 'isActive'],
          },
          {
            name: 'idx_insight_template_run_trigger_user',
            columnNames: ['userId'],
          },
        ],
      }),
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await softDropTable(queryRunner, 'insight_template_run_triggers');
  }
}
