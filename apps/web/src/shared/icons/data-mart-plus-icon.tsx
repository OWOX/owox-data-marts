...
export const DataMartPlusIcon = ({ className, size = 24 }: DataMartPlusIconProps) => {
  return (
    <svg
      ...
      fill='none'
    >
      <path d='M16 16H22' stroke='currentColor' strokeLinecap='round' strokeLinejoin='round' />
      <path d='M19 13V19' stroke='currentColor' strokeLinecap='round' strokeLinejoin='round' />
      <path
