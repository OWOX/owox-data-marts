    ...
    <AccordionItem value='googlechat-details'>
      ...
      <AccordionContent>
        <p className='mb-2'>
          ...
          <strong>Destinations</strong> tab, and create a report in the Google Chat block.
        </p>
        <p className='mb-2'>
        ...
        <p className='mb-2'>
          ...
          <ExternalAnchor
            className='underline'
            href='https://docs.owox.com/docs/destinations/manage-destinations/?utm_source=owox_data_marts&utm_medium=destination_entity&utm_campaign=tooltip-google-chat'
          >
            OWOX documentation
          </ExternalAnchor>
          .
