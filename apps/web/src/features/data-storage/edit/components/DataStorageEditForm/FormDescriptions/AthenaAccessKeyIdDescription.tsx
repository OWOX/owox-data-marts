  ...
  return (
    <Accordion variant="common" type="single" collapsible>
      <AccordionItem value="athena-access-key-id-details">
        ...
        <AccordionContent>
          <p className="mb-2">
            Before accessing your AWS Access Key ID, make sure you have a user
            with the necessary permissions to use Athena and Glue in your AWS
            account.
          </p>
          ...
          <p className="mb-2">
            The Access Key ID is part of your AWS credentials needed to connect
            and authenticate.
          </p>
          ...
          <ol className="list-inside list-decimal space-y-2 text-sm">
            ...
            <li>
              Under <strong>Access keys</strong>, find your existing keys or
              create a new access key.
            </li>
            <li>
              When you create a new key, download and securely store the Access
