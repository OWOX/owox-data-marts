...
# Improved the Report Column Picker experience by adding a column search and refining the layout
...
- Search works together with the **Show selected only** option.
